...
class DSSMTrainable:
    def __init__(self, user_feature=None, item_feature=None, train_dataloader=None, val_dataloader=None, test_dataloader=None, output=1, similarity='dot',
                 ...
                 dropout=0.2, l2_normalization=False, use_senet=False, model_path=None, dimensions=16, test_interval=4):
        ...
        if train_dataloader is None:
            ...
            self.model = DSSM(user_feature, item_feature, user_dnn_size=user_dnn_size, item_dnn_size=item_dnn_size, output=self.output, similarity=similarity,
    ...
    def train(self, epochs=10, optimizer='Adam', lr=1e-5, lr_decay_rate=0, lr_decay_step=0, task_indices=[0]):
        ...
        for epoch in range(epochs):
            ...
            for data in self.train_dataloader:
                ...
                y_pre, user_emb, item_emb = self.model(x, user_embeddings, item_embeddings, group=group_list)

                loss = get_loss(loss=self.loss_func, true=y, pred=y_pre,group=group_list, user_embedding=user_emb, item_embedding=item_emb)
